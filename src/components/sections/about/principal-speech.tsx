      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-black text-foreground" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
              Principal&apos;s Message
            </h2>
          </motion.div>
        </div>
          ...
          >
            <div className="relative p-8 md:p-12 bg-card border border-border shadow-sm rounded-r-lg group">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed font-medium text-sm md:text-base border-l border-border/20 pl-6">
                  <p>
