    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="relative bg-card border border-border rounded-lg p-8 hover:border-primary/50 transition-all duration-300 overflow-hidden">
              {/* Corner Accents */}
              <div className="absolute top-0 right-0 w-8 h-8 border-t-2 border-r-2 border-primary/10 rounded-tr-lg" />
              
              <div className="flex items-center gap-5 mb-6">
                <div className="relative w-14 h-14 flex items-center justify-center bg-muted/50 border border-border rounded-md group-hover:border-primary/30 transition-colors">
                ...
                <h2 className="text-2xl font-black text-foreground" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
          ...
          >
            <div className="relative bg-card border border-border rounded-lg p-8 hover:border-primary/50 transition-all duration-300 overflow-hidden">
              ...
              <p className="text-xl md:text-2xl font-bold text-primary mb-4" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
