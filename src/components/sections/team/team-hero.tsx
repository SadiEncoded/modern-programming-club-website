      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          <div className="text-center">
            <div className="text-4xl md:text-5xl font-black text-foreground" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
          ...
          <div className="text-center">
            <div className="text-4xl font-black text-foreground" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
              {stats?.coreTeam || "15+"}
            </div>
            <div className="text-sm text-muted-foreground font-medium mt-1">Core Team</div>
          </div>
          <div className="w-px h-12 bg-border" />
          <div className="text-center">
            <div className="text-4xl font-black text-foreground" style={{ fontFamily: "var(--font-orbitron), sans-serif" }}>
            ...
            <div className="text-sm text-muted-foreground font-medium mt-1">Dedication</div>
          </div>
        </motion.div>
      </div>
    </section>
