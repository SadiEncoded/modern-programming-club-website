...
import { RegisterForm } from "@/components/sections/join/register-form";
          ...
          <div className="flex flex-col justify-center space-y-12">
            ...
            <div className="grid gap-8 sm:grid-cols-2">
              {JOIN_DATA.benefits.map((benefit, index) => {
                const Icon = ICON_MAP[benefit.title.includes("Competitive") ? "Trophy" : 
                             benefit.title.includes("Skill") ? "Code2" : 
                             benefit.title.includes("Community") ? "Users2" : "Zap"];
                return (
                  <motion.div 
                    key={benefit.title}
